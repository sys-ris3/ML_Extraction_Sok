...
layer make_batchnorm_layer(int batch, int w, int h, int c)
{
    ...
    DMSG("Batch Normalization Layer: %d x %d x %d image\n", w,h,c);
    layer l = {0};
    l.type = BATCHNORM;
    l.batch = batch;
    l.h = l.out_h = h;
    ...
    DMSG("batchnorm Layer: l.output:%p,l.biases:%p,l.scales:%p,l.rolling_mean:%p, l.rolling_variance:%p\n", l.output, l.biases, l.scales,l.rolling_mean,l.rolling_variance);
